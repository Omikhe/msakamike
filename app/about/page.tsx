  ...
  return (
    <div className="flex flex-col gap-10 mx-4 sm:mx-6 lg:mx-8 xl:mx-12 mt-8 lg:mt-12 pb-24 lg:pb-16 max-w-5xl">
      ...
      <section className="flex flex-col md:flex-row items-start md:items-center gap-6 p-6 sm:p-8 bg-[#181818] border border-[#262626] rounded-3xl">
        <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden border-2 border-pink-600 flex-shrink-0 bg-pink-950/30">
          <Image
        ...
        <div className="flex flex-col gap-3 flex-1">
          <div>
            ...
            <p className="text-pink-600 font-semibold text-base sm:text-lg mt-0.5">
              {aboutData.tagline}
            </p>
          </div>
          ...
          <div className="pt-1">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold bg-pink-600 text-white hover:bg-pink-500 transition-colors shadow-md focus:outline-none focus:ring-2 focus:ring-pink-600"
            >
